...
mov ebx, dword[doubleVariable9]
movzx eax, word[wordVariable9]
sub ebx, eax
...
movsxd rax, eax
mov qword[quadAnswer11], rax
mov qword[quadAnswer11+4], rdx
...
mov eax, dword[doubleVariable20]
movsxd rbx, eax
