 ...
 * Description: Main function of the program with implementation
 * of card.cpp and player.cpp. This program mimics the card game
 * "War" where two players have a deck of cards.  They will
 * deal two cards at a time and compare the values of the cards.
 * The person with the highest value wins.
 * Input: 
 * Output: Player card decks, placing of two cards and winners.
 */
...
int main(){
    ...
    cin >> seed;
    cout << seed << endl;
    srand (seed); // Makes things more random
